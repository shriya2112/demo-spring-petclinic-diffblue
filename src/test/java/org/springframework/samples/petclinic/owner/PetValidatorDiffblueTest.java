...
class PetValidatorDiffblueTest {
     ...
     *
     * <p>Method under test: {@link PetValidator#validate(Object, Errors)}
     */
    @Test
    ...
    void testValidate() {
        ...
        BindException errors =
                new BindException(pet, "org.springframework.samples.petclinic.owner.Pet");
    ...
    void testValidate3() {
        ...
        assertEquals(
                "org.springframework.validation.BeanPropertyBindingResult: 1 errors\n"
                        ...
                        + ".lang.String,required]; arguments []; default message [required]",
                errors.getLocalizedMessage());
        assertEquals(
                "org.springframework.validation.BeanPropertyBindingResult: 1 errors\n"
                        + "Field error in object 'org.springframework.samples.petclinic.owner.Pet' on field 'name': rejected value"
